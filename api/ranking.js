module.exports = async (req, res) => {
  ...
  const catalogDatabase = {
    '0': [
      ...
      { title: "＼1袋あたり2,093円〜！／ 【令和7年産100%使用】 白米 無洗米 和の輝き ブレンド米 10kg (5kg×2袋) 15kg", price: 4580, reviews: 6494, score: 4.70, shop: "アイリスオーヤマ公式 楽天市場店", url: "https://ranking.rakuten.co.jp/" },
    ...
    '100804': [
      { title: "【折りたたみ頑丈】 蓋付き 収納ボックス 3個セット 前開き キャスター付き 積み重ね 衣類整理 衣装ケース", price: 3980, reviews: 21, score: 4.88, shop: "暮らしのインテリア館", url: "https://ranking.rakuten.co.jp/" },
    ...
    '100227': [
      ...
      { title: "【新米予約★即納】 令和7年産・8年産 新潟県産 コシヒカリ 10kg (5kg×2袋) 白米 精米 お米", price: 4580, reviews: 32, score: 4.90, shop: "新潟米直販センター", url: "https://ranking.rakuten.co.jp/" },
  ...
  try {
    ...
    console.log('Scraper fallback triggered');
  }
